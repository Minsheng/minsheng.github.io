jQuery("#simulation")
  .on("click", ".s-84779577-ba77-4938-87b2-ca2bb9509fd4 .click", function(event, data) {
  ...
  .on("focusin", ".s-84779577-ba77-4938-87b2-ca2bb9509fd4 .focusin", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
              ...
              "actions": [
                {
                  ...
                  "parameter": [ {
                    "#s-84779577-ba77-4938-87b2-ca2bb9509fd4 #s-Rectangle_7": {
                      "attributes": {
  ...
  .on("focusout", ".s-84779577-ba77-4938-87b2-ca2bb9509fd4 .focusout", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
