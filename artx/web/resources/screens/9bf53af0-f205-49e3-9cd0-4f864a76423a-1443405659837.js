jQuery("#simulation")
  .on("click", ".s-9bf53af0-f205-49e3-9cd0-4f864a76423a .click", function(event, data) {
  ...
  .on("focusin", ".s-9bf53af0-f205-49e3-9cd0-4f864a76423a .focusin", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
              ...
              "actions": [
                {
                  ...
                  "parameter": [ {
                    "#s-9bf53af0-f205-49e3-9cd0-4f864a76423a #s-Rectangle_7": {
                      "attributes": {
  ...
  .on("focusout", ".s-9bf53af0-f205-49e3-9cd0-4f864a76423a .focusout", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
