jQuery("#simulation")
  .on("click", ".s-2483df7c-338d-4eec-96ce-77bc42cc5f21 .click", function(event, data) {
  ...
  .on("focusin", ".s-2483df7c-338d-4eec-96ce-77bc42cc5f21 .focusin", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
              ...
              "actions": [
                {
                  ...
                  "parameter": [ {
                    "#s-2483df7c-338d-4eec-96ce-77bc42cc5f21 #s-Rectangle_7": {
                      "attributes": {
  ...
  .on("focusout", ".s-2483df7c-338d-4eec-96ce-77bc42cc5f21 .focusout", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
