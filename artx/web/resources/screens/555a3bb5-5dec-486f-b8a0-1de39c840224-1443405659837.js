jQuery("#simulation")
  .on("click", ".s-555a3bb5-5dec-486f-b8a0-1de39c840224 .click", function(event, data) {
  ...
  .on("focusin", ".s-555a3bb5-5dec-486f-b8a0-1de39c840224 .focusin", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
              ...
              "actions": [
                {
                  ...
                  "parameter": [ {
                    "#s-555a3bb5-5dec-486f-b8a0-1de39c840224 #s-Rectangle_7": {
                      "attributes": {
  ...
  .on("focusout", ".s-555a3bb5-5dec-486f-b8a0-1de39c840224 .focusout", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
