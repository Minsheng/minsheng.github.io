jQuery("#simulation")
  .on("click", ".s-c2e4e839-d047-46ba-b9a8-c0b37961035c .click", function(event, data) {
              ...
              "actions": [
                {
                  "action": "jimNavigation",
                  "parameter": {
                    "target": "screens/2483df7c-338d-4eec-96ce-77bc42cc5f21"
                  },
                  "exectype": "serial",
                  "delay": 0
                }
  ...
  .on("focusin", ".s-c2e4e839-d047-46ba-b9a8-c0b37961035c .focusin", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
              ...
              "actions": [
                {
                  ...
                  "parameter": [ {
                    "#s-c2e4e839-d047-46ba-b9a8-c0b37961035c #s-Rectangle_7": {
                      "attributes": {
  ...
  .on("focusout", ".s-c2e4e839-d047-46ba-b9a8-c0b37961035c .focusout", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
