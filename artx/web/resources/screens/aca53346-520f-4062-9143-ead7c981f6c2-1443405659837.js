jQuery("#simulation")
  .on("click", ".s-aca53346-520f-4062-9143-ead7c981f6c2 .click", function(event, data) {
  ...
  .on("focusin", ".s-aca53346-520f-4062-9143-ead7c981f6c2 .focusin", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
              ...
              "actions": [
                {
                  ...
                  "parameter": [ {
                    "#s-aca53346-520f-4062-9143-ead7c981f6c2 #s-Rectangle_7": {
                      "attributes": {
  ...
  .on("focusout", ".s-aca53346-520f-4062-9143-ead7c981f6c2 .focusout", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
