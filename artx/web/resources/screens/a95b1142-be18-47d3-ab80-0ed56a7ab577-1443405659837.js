jQuery("#simulation")
  .on("click", ".s-a95b1142-be18-47d3-ab80-0ed56a7ab577 .click", function(event, data) {
              ...
              "actions": [
                {
                  "action": "jimNavigation",
                  "parameter": {
                    "target": "screens/36fdbffa-53ef-4667-8722-f1be598d0b25"
                  },
                  "exectype": "serial",
                  "delay": 0
                }
  ...
  .on("focusin", ".s-a95b1142-be18-47d3-ab80-0ed56a7ab577 .focusin", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
              ...
              "actions": [
                {
                  ...
                  "parameter": [ {
                    "#s-a95b1142-be18-47d3-ab80-0ed56a7ab577 #s-Rectangle_7": {
                      "attributes": {
  ...
  .on("focusout", ".s-a95b1142-be18-47d3-ab80-0ed56a7ab577 .focusout", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
