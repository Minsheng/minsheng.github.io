    ...
    function processData(data) {
      ...
      if (data.length > 0) {
        data.forEach(function(d) {
          if (!hierarchy[d["name"]]) {
            var secondlvl = {};
            // "secondlvl name":[{"name":"software name}]
            // third level
            secondlvl[d["children"][0]["name"]] = [d["children"][0]["children"][0]];
            ...
            if (!hierarchy[d.name][d.children[0].name]) {
              hierarchy[d.name][d.children[0].name] = [d.children[0].children[0]];
            } else {
              hierarchy[d.name][d.children[0].name].push(d.children[0].children[0]);
            }
          }
        });
      ...
      for (var secondlvlKey in hierarchy) {
        console.log(hierarchy[secondlvlKey]);
        var secondlvlNodes = {
          "name": secondlvlKey,
          "children": []
        };
